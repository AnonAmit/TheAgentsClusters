# memory.py
# Attempt to fix ChromaDB's sqlite3 version requirement
# This must be at the absolute top, before any other imports that might import sqlite3 indirectly
try:
    __import__('pysqlite3')
    import sys
    sys.modules['sqlite3'] = sys.modules.pop('pysqlite3')
    print("INFO: Successfully swapped sqlite3 with pysqlite3 for ChromaDB.")
except ImportError:
    print("INFO: pysqlite3 not found, standard sqlite3 will be used (may cause issues with ChromaDB).")
    pass # Fall back to system sqlite3 if pysqlite3 isn't installed
